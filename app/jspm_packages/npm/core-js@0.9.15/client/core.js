  ...
  !function(undefined) {
    ...
    (function(modules) {
      ...
      var $ = __webpack_require__(2),
          ...
          $def = __webpack_require__(9),
          toLength = $.toLength;
      $def($def.P + $def.F * !__webpack_require__(17)(function() {
        'q'.endsWith(/./);
      ...
      var $def = __webpack_require__(9);
      $def($def.P, 'String', {repeat: __webpack_require__(45)});
    }, function(module, exports, __webpack_require__) {
      'use strict';
      var $ = __webpack_require__(2);
      ...
      $def($def.S + $def.F * !__webpack_require__(49)(function(iter) {
        Array.from(iter);
      ...
      module.exports = function(NAME, wrapper, methods, common, IS_MAP, IS_WEAK) {
        ...
        function fixMethod(KEY) {
          var fn = proto[KEY];
          __webpack_require__(10)(proto, KEY, KEY == 'delete' ? function(a) {
        ...
        if (!$.isFunction(C) || !(IS_WEAK || !BUGGY && proto.forEach && proto.entries)) {
          ...
          var inst = new C,
              ...
              buggyZero;
          if (!__webpack_require__(49)(function(iter) {
            new C(iter);
          })) {
      ...
      var $def = __webpack_require__(9);
      $def($def.S, 'RegExp', {escape: __webpack_require__(16)(/([\\\-[\]{}()*+?.,^$|])/g, '\\$1', true)});
    }, function(module, exports, __webpack_require__) {
      var $ = __webpack_require__(2),
          $def = __webpack_require__(9),
          ownKeys = __webpack_require__(72);
      ...
      $def($def.P + $def.F, 'Function', {part: __webpack_require__(87)});
    }, function(module, exports, __webpack_require__) {
      var $ = __webpack_require__(2),
          $def = __webpack_require__(9),
          ownKeys = __webpack_require__(72);
      ...
      function setStatics(keys, length) {
        $.each.call(keys.split(','), function(key) {
          if (length == undefined && key in $Array)
            ...
            statics[key] = __webpack_require__(13)(Function.call, [][key], length);
        });
      }
